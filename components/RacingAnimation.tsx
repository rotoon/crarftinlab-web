...
export function RacingTrack1() {
  ...
  return (
    <div ref={containerRef} className="relative h-[300vh]">
      <div className="sticky top-[100px] h-[900px] overflow-hidden relative">
...
export function RacingTrack2() {
  ...
  return (
    <div ref={containerRef} className="relative h-[300vh] justify-end flex">
      <div className="sticky top-[20px] h-[900px] overflow-hidden relative">
